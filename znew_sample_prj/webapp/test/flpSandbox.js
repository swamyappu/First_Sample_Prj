		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BTP App",
									"targetURL": "#compracticeznewsampleprj-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compracticeznewsampleprj-display": {
								"semanticObject": "compracticeznewsampleprj",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.practice.znewsampleprj",
									"url": sap.ui.require.toUrl("com/practice/znewsampleprj")
								}
							}
						}
					}
